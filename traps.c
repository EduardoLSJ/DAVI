...
void __interrupt(high_priority) _OscillatorFail(void);
void __interrupt(high_priority) _AddressError(void);
void __interrupt(high_priority) _StackError(void);
void __interrupt(high_priority) _MathError(void);
...
void __interrupt(high_priority) _DefaultInterrupt(void);
